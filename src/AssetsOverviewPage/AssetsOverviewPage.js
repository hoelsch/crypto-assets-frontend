...
function AssetsOverviewPage(props) {
        ...
        for (let j = 0; j < fetchedAssets.length; j++) {
          ...
          for (let i = 0; i < cryptos.length; i++) {
            ...
            if (symbol === expectedSymbol) {
              ...
              let colors = {"bitcoin": "rgb(98,215,198)", "ethereum": "rgb(178,139,245)", "cardano": "#CF6679"};
  ...
  return (
    <>
      <Button sx={{ p: 1, position: "fixed", top: 35, right: 35}} variant="text" onClick={props.handleClickLogout}>Logout</Button>
      <Box p={4}>
        <Grid container>
